...
import reporting.handler.GetAvgClosingPriceHandler;
import reporting.handler.GetClosingPriceHandler;
import reporting.handler.GetDatasetTimeRangeHandler;
import reporting.handler.GetTopGainingHandler;
...
public class Application {
    ...
    public void init() {
        ...
        // note we should configure global log tags with host and java.service name.
        log.info("java.Application successfully initialized.");
    }
